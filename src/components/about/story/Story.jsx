...
const Story = () => {
  return (
    <motion.div
      className="text-center pb-16 pt-20 bg-[rgb(110,97,70)]"
      initial="hidden"
      whileInView="visible"
      viewport={{ once: true }}
      variants={fadeInUp}
      ...
      <div className="max-w-7xl mx-auto">
                  ...
                  <div className="bg-[#d1c8c1] rounded-lg overflow-hidden shadow-lg">
                    {storyPoints.map((item, i) => {
                      return (
                        ...
                        >
                          <div className="block rounded-xl flex gap-2 items-center    p-2  font-medium  transition">
                            <FaAnglesRight /> {item}
                          </div>
                        </motion.div>
                      );
        ...
        <div className="flex items-center justify-center mb-4">
          <motion.div
            ...
            transition={{ duration: 0.7 }}
          >
            <p className="text-xl md:text-xl pt-12 text-white">
