...
import CommonBanner1 from '@/common-components/CommonBanner1/CommonBanner1';
...
const NewBlogPage = async () => {
    const page = 1;
    const res = await axios.get(`https://admin-backend-prod-xvpb.onrender.com/api/blogs/all/ed_tech?type=blog&status=Published&page=${page}&limit=${LIMIT}`,
        { cache: "no-store" }
    );
