      ...
      <section className="relative h-[85vh] m-0 p-0">
        <div className="absolute inset-0 overflow-hidden h-[70vh] rounded-bl-[60px] rounded-br-[60px]">
          ...
          <div className="absolute inset-0 flex flex-col items-center justify-center text-white text-center">
            <h1 className="text-2xl md:text-5xl font-primary tracking-widest font-medium">
              Eco Gallery
            </h1>
      ...
      <section className="py-8 px-4 -mt-24 rounded-bl-[60px] rounded-br-[60px] ">
        <div className="max-w-[86rem] mx-auto">
          <div className="flex items-center justify-center mb-5">
            ...
            <h2 className="text-2xl md:text-5xl font-primary text-[rgb(110,97,70)] font-semibold tracking-wider text-center">
